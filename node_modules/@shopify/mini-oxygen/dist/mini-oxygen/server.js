...
import { Request as Request2, Response as Response2, fetch } from "@miniflare/core";
  ...
  return async (req, res) => {
    ...
    try {
      ...
      for (const key of response.headers.keys()) {
        const val = key.toLowerCase() === "set-cookie" ? response.headers.getAll(key) : response.headers.get(key);
        headers[key] = val;
      }
